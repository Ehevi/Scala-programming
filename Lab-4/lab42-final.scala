...
object Appl42 {
  ...
  def main(args: Array[String]) {
    ...
    println("Testing sumArrayIter with a1To5 = " +
    ...
    println("")
    println("Testing sumSqrArrayIter with a1To5 = " +
            a1To5.mkString("Array(", ", ", ") ..."))
    expectResult = 55
    checkPredicate(sumSqrArrayIter(a1To5) == expectResult,
                   "sumSqrArrayIter(0, a1To5) == " + expectResult)
    checkPredicate(sumSqrArrayRec1(0, a1To5) == expectResult,
                   "sumSqrArrayRec1(0, a1To5) == " + expectResult)
    checkPredicate(sumSqrArrayRec2(a1To5) == expectResult,
                   "sumSqrArrayRec2(a1To5) == " + expectResult)
    checkPredicate(sumSqrArrayRec3(a1To5) == expectResult,
                   "sumSqrArrayRec3(a1To5) == " + expectResult)

    println("")
    println("Testing prodArrayIter with a1To5 = " +
            a1To5.mkString("Array(", ", ", ") ..."))
    expectResult = 120
    checkPredicate(prodArrayIter(a1To5) == expectResult,
                   "prodArrayIter(0, a1To5) == " + expectResult)
    checkPredicate(prodArrayRec1(0, a1To5) == expectResult,
                   "prodArrayRec1(0, a1To5) == " + expectResult)
    checkPredicate(prodArrayRec2(a1To5) == expectResult,
                   "prodArrayRec2(a1To5) == " + expectResult)

    println("")
    val aNegative1To5 = (-5 to -1).toArray
    println("Testing sumAbsArrayIter with aNegative1To5 = " +
            aNegative1To5.mkString("Array(", ", ", ") ..."))
    expectResult = 15
    checkPredicate(sumAbsArrayIter(aNegative1To5) == expectResult,
                   "sumAbsArrayIter(0, aNegative1To5) == " + expectResult)
    checkPredicate(sumAbsArrayRec1(0, aNegative1To5) == expectResult,
                   "sumAbsArrayRec1(0, aNegative1To5) == " + expectResult)
    checkPredicate(sumAbsArrayRec2(aNegative1To5) == expectResult,
                   "sumAbsArrayRec2(aNegative1To5) == " + expectResult)
  }
}